...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='UCL', help='chooses which model to use.')
        ...
        parser.add_argument('--fks', type=int, default=7, help='first kernel size')
        parser.add_argument('--iokan', type=bool, default=False, help='whether to use In/Out ConvKAN')
        parser.add_argument('--patch_size', type=int, default=4, help='patch size of KAT block')
        parser.add_argument('--n_kat_blocks', type=int, default=5, help='num of KAT block')
        ...
        parser.add_argument('--netG', type=str, default='katgen', choices=['resnet_9blocks', 'resnet_6blocks', 'snsp', 'convkat'], help='specify generator architecture')
        parser.add_argument('--mixer', type=str, default='kan', choices=['identity', 'kan', 'triplekan'], help='specify mixer for KAT block')
        parser.add_argument('--act_type', type=str, default='gelu', choices=['gelu', 'relu', 'identity'], help='specify activation for KAT')
